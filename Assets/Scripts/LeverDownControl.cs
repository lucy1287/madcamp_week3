...
public class LeverDownControl : MonoBehaviour
{
    public Sprite leverDownSprite; // 초기 레벨다운 스프라이트
    public Sprite leverUpSprite; // 레벨업 스프라이트
    public ManualPlatform manualPlatform;

    private SpriteRenderer spriteRenderer;
    private bool isLeverUp = false; // 현재 상태를 나타내는 변수
